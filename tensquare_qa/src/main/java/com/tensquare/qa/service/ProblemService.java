...
public class ProblemService {
	...
	public Page<Problem> newlist(String labelid,int page,int size){
		Pageable problem=PageRequest.of(page,size);
		return problemDao.newlist(labelid,problem);
	}
	public Page<Problem> hotlist(String labelid,int page,int size){
		Pageable problem=PageRequest.of(page,size);
		return problemDao.hotlist(labelid,problem);
	}
	public Page<Problem> watlist(String labelid,int page,int size){
		Pageable problem=PageRequest.of(page,size);
		return problemDao.waitlist(labelid,problem);
	}
	/**
	 * 查询全部列表
	 * @return
